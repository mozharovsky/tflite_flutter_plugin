...
TensorFlow Lite plugin for Flutter apps.
  ...
  s.ios.vendored_frameworks = ['TensorFlowLiteC.framework', 'TensorFlowLiteCMetal.framework', 'TensorFlowLiteCCoreML.framework']
  ...
  s.xcconfig = { 'OTHER_LDFLAGS' => '-framework TensorFlowLiteC TensorFlowLiteCMetal TensorFlowLiteCCoreML -all_load' }
